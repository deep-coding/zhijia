 ...
 */
public abstract class AbstractFavListPageDirective {
    ...
    public void doExecute(Environment env, Map params,
        ...
        String ftype = Freemarkers.getString(params, FTYPE, Info.FAV_MARK);
        ...
        if (isPage) {
            ...
            Page<VoteMark> pagedList = service.findPage(ftype, fid, userId, pageable);
            ...
            List<VoteMark> list = service.findList(ftype, fid, userId, limitable);
    ...
    @Autowired
    private VoteMarkService service;
}
